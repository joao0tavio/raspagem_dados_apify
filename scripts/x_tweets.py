...
ATOR_APIFY = "xtdata/twitter-x-scraper"
TWEETS_POR_TERMO = 5
TERMOS = [
    "ESG",
    "Sustentabilidade"
...
def raspar_tweets() -> list:
    cliente = ApifyClient(TOKEN_APIFY)
    
    entradas = {
        "searchTerms": TERMOS,
        "maxItems": TWEETS_POR_TERMO,
        "sort": "Latest", # Pode alterar para "Top" dependendo da necessidade
        "tweetLanguage": "pt",
        "includeSearchTerms": True,
    }
    
    print("Buscando tweets com os termos")
